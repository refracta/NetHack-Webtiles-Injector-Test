...
###
### Start sys/unix/hints/linux-webtiles PRE
###
...
VARFILEPERM = 0600
GAMEPERM = 0755
### End sys/unix/hints/linux-webtiles PRE
...
json: 
	(mkdir -p json-c/build; cd json-c/build; cmake .. -DCMAKE_INSTALL_PREFIX=../../json_output; make -j4 && make install)
...
###
### Start sys/unix/hints/linux-webtiles POST
###
### End sys/unix/hints/linux-webtiles POST
